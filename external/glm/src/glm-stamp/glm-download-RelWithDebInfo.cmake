...
set(command "C:/Program Files/CMake/bin/cmake.exe;-P;D:/Git/treesim/external/glm/tmp/glm-gitclone.cmake")
set(log_merged "")
set(log_output_on_failure "")
set(stdout_log "D:/Git/treesim/external/glm/src/glm-stamp/glm-download-out.log")
set(stderr_log "D:/Git/treesim/external/glm/src/glm-stamp/glm-download-err.log")
execute_process(
  COMMAND ${command}
...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  D:/Git/treesim/external/glm/src/glm-stamp/glm-download-*.log")
  endif()
  ...
  if(NOT "Visual Studio 17 2022" MATCHES "Ninja")
    set(msg "glm download command succeeded.  See also D:/Git/treesim/external/glm/src/glm-stamp/glm-download-*.log")
    message(STATUS "${msg}")
  endif()
endif()
